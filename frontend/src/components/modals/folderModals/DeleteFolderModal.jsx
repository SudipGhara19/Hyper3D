...
import { deleteFolder } from '../../../api/folderService.js';

function DeleteFolderModal({ showModal, setShowModal, fName }) {
    ...
    const handleDelete = async () => {
        try {
            ...
            const response = await deleteFolder(fName);
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
            <div className="bg-white p-6 rounded-lg w-[90%] max-w-sm shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">Do you really want to delete this folder? This action cannot be undone.</p>
